...
export default function Home() {
  ...
  const nextSlide = () => setCurrentSlide((prev) => (prev + 1) % HERO_PRODUCTS.length);
  const prevSlide = () => setCurrentSlide((prev) => (prev - 1 + HERO_PRODUCTS.length) % HERO_PRODUCTS.length);
  
  const product = HERO_PRODUCTS[currentSlide];
            ...
            <section className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-5 flex flex-col gap-6">
                  ...
                  {/* Danh sách Tool Bán Chạy */}
                  <div className="flex flex-col gap-4">
                    {/* Tool 1 */}
                    <Link 
                      href="/tools/ban-content"
                      data-testid="hot-tool-ban-content"
                      className="flex items-center gap-4 p-4 rounded-xl border border-[#3A2266]/50 bg-zinc-900/50 backdrop-blur-sm hover:border-neonPurple transition group shadow-lg"
                    >
                      <div className="w-20 h-20 rounded-lg bg-[#3A2266] flex items-center justify-center flex-shrink-0 relative overflow-hidden">
                        <img src="/software-box.jpg" alt="Icon" className="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition" />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-[10px] bg-[#3A2266] text-yellow-500 px-2 py-0.5 rounded flex items-center gap-1"><Star className="w-3 h-3 fill-yellow-500" /> 5.0</span>
                          <span className="text-[10px] bg-neonGreen/20 text-neonGreen px-2 py-0.5 rounded border border-neonGreen/30">Mới</span>
                        </div>
                        <h4 className="font-bold text-white text-sm">Ban Content Automation</h4>
                        <p className="text-neonPurple font-bold mt-1">499,000đ<span className="text-xs text-zinc-500 font-normal">/tháng</span></p>
                      </div>
                    </Link>
                    ...
                    <Link 
                      ...
                      className="flex items-center gap-4 p-4 rounded-xl border border-[#3A2266]/50 bg-zinc-900/50 backdrop-blur-sm hover:border-neonGreen transition group shadow-lg"
                    >
                      <div className="w-20 h-20 rounded-lg bg-[#3A2266] flex items-center justify-center flex-shrink-0 relative overflow-hidden">
                        <img src="/software-box-2.jpg" alt="Icon" className="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition" />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-[10px] bg-[#3A2266] text-yellow-500 px-2 py-0.5 rounded flex items-center gap-1"><Star className="w-3 h-3 fill-yellow-500" /> 5.0</span>
                        ...
                        <p className="text-neonGreen font-bold mt-1">599,000đ<span className="text-xs text-zinc-500 font-normal">/tháng</span></p>
                      </div>
                    </Link>
                  </div>
...
<div className="h-48 bg-gradient-to-br from-[#5A3399]/40 to-transparent relative overflow-hidden flex items-center justify-center">
